...
const CreateSubCategoryExcelRelational = () => {
    ...
    data.forEach((_data) => {
        ...
        for (let index = 1; index < dataArray.length; index++) {
            ...
            let brandName = categories.find(category => category?.category_name?.toLowerCase() === element?.A?.toLowerCase())
...
export default CreateSubCategoryExcelRelational;