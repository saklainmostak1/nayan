...
const SettingsSubCategory = () => {
    ...
    const sub_category = module_settings.filter(moduleI => moduleI.table_name === 'sub_category')
    const columnListSelected = sub_category[0]?.column_name
                                    ...
                                    <form onSubmit={sub_category_settings_create}>
                                        <div class="col-md-9 offset-md-1">
                                            <div class="form-group row student d-none">
                                                ...
                                                <div class="col-md-4">
                                                    <input
                                                        defaultValue={sub_category[0]?.table_name}
