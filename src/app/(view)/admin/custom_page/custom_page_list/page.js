...
const CustomPageList = ({ searchParams }) => {
    ...
    const { data: custom_page = [], refetch, isLoading
        ...
        queryFn: async () => {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/custom_page/custom_page_list`)
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/custom_page/custom_page_list_paigination/${currentPage}/${dataPerPage}`;
    ...
    const front_service_box_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/custom_page/custom_page_delete/${id}`, {
                method: "POST",
    ...
    const pop_up_search = () => {
        ...
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/custom_page/custom_page_search`, {
