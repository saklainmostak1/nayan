...
const WarrantyList = ({ searchParams }) => {
    ...
    console.log(moduleInfo.filter(moduleI => moduleI.controller_name === 'warranty'))
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'warranty')
    ...
    const Category = module_settings.filter(moduleI => moduleI.table_name === 'warranty')
    ...
    const columnNames = warrantys && warrantys.length > 0 ? Object.keys(warrantys[0]) : [];
    ...
    const warranty_column_change = (selectedItems) => {
    ...
    const warranty_print = async () => {
        try {
            ...
            // Render rows of data
            const longTextColumns = ['warranty_name', 'description'];
    ...
    const warranty_excel_download = async () => {
    ...
    const warranty_PDF_download = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Error generating PDF In warranty');
            }
            ...
            <div class="body-content bg-light">
                ...
                <div class=" border-primary shadow-sm border-0">
                    <div class=" card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                        <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Warranty Search</h5>
                        <div class="card-title font-weight-bold mb-0 card-header-color float-right">

                            <Link href={`/Admin/warranty/warranty_create?page_group=${page_group}`} class="btn btn-sm btn-info">Back To Create Warranty</Link>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form class="">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <label class="col-form-label col-md-3"><strong>Warranty Name:</strong></label>
                                    <div class="col-md-3">
                                        <input
                                            value={searchQuery}
                                            onChange={(e) => setSearchQuery(e.target.value)}
                                            type="text" name="student_id" class="form-control form-control-sm  alpha_space student_id" id="student_id" placeholder="Warranty Name" />
                                    </div>
                                ...
                                <div class="form-group row student">
                                    ...
                                    <div className="col-md-9">
                                        ...
                                        <Select
                                            ...
                                            onChange={warranty_column_change}
                                        />
            ...
            return options;
                            ...
                            <div class="form-group row">
                                <div class="offset-md-2 col-md-12 float-left">
                                    <input type="button" onClick={warranty_search} name="search" class="btn btn-sm btn-info search_btn mr-2" value="Search" />
                                    <input type="button" onClick={warranty_print} name="search" class="btn btn-sm btn-success print_btn mr-2" value="Print" />
                                    <button class="btn btn-sm btn-indigo pdf_btn mr-2" style={buttonStyles} onClick={warranty_PDF_download} disabled={loading}>
...
{errorr && <p>Error: {errorr}</p>}
                                    ...
                                    <input
                                        type="button"
                                        onClick={warranty_excel_download}
                                        name="search"
                                    ...
                                    <input
                                        type="button"
                                        onClick={warranty_word_download}
                                        name="search"
                                        className="btn btn-sm btn-secondary excel_btn mr-2"
                                        value="Download Docx"
                                    />
            ...
            <div class=" border-primary  shadow-sm border-0">
                <div class="card-header  custom-card-header py-1  clearfix bg-gradient-primary text-white">
                    <h5 class="card-title card-header-warranty font-weight-bold mb-0  float-left mt-1">warranty List</h5>
                    <div class="card-title card-header-warranty font-weight-bold mb-0  float-right"> <a href="" class="btn btn-sm btn-info">Create warranty</a> </div>
                </div>
                    ...
                    {loading ? <div className='text-center'>
                        ...
                        <div class="table-responsive">
                            <table className="table table-bordered table-hover table-striped table-sm">
                                ...
                                <tbody>
                                    {searchResults.map((warranty, i) => (
                                        <tr key={i}>
                                            {selectedColumns.map((column, j) => (
                                                <td key={j} style={['warranty_name', 'description'].includes(column) ? longTextStyle : {}}>
                                                    {column === 'serial' ? (
                                                        // Rendering serial number if the column is 'serial'
                                                        i + 1
                                                    ) : column === 'file_path' ? (
                                                        ...
                                                        <>
                                                            <img
                                                                ...
                                                                style={{ width: '100px' }}
                                                                src={`${process.env.NEXT_PUBLIC_API_URL}:5003/${warranty.file_path}`}
                                                                alt="No Image"
                                                            />
                                                        </>
                                                    )
                                                        ...
                                                        column === 'status_id' ? (
                                                            // Special handling for the 'status' column
                                                            <>
                                                                {warranty.status_id === 1 && <p>Active</p>}
                                                                {warranty.status_id === 2 && <p>Inactive</p>}
                                                                {warranty.status_id === 3 && <p>Pending</p>}
                                                            </>
                                                        )
                                                            ...
                                                            : column === 'action' ? (
                                                                ...
                                                                <div className="flex items-center ">
                                                                    <Link href={`/Admin/warranty/warranty_edit/${warranty.id}?page_group=${page_group}`}>
                                                                    ...
                                                                    <Link href={`/Admin/warranty/warranty_copy/${warranty.id}?page_group=${page_group}`}>
                                                                    ...
                                                                    {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                        <button
                                                                            ...
                                                                            title='Delete'
                                                                            onClick={() => warranty_delete_searching(warranty.id)}
                                                                            style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                ...
                <table className="table table-bordered">
                                        ...
                                        <tbody>
                                            {pageUsers.length === 0 ? (
                                                ...
                                                pageUsers?.map((warranty, index) => (
                                                    <tr key={warranty.id}>
                                                        {selectedColumns?.map(column => (
                                                            <td key={column} style={['warranty_name', 'description'].includes(column) ? longTextStyle : {}}>
                                                                {column === 'serial' ? 
                                                                 ...
                                                                 :
                                                                    ...
                                                                    column === 'status_id' ? (
                                                                        warranty[column] === 1 ? 'Active' : warranty[column] === 2 ? 'Inactive' : warranty[column] === 3 ? 'Pending' : 'Unknown'
                                                                    )
                                                                    :
                                                                        column === 'action' ? (
                                                                            <div className="flex items-center ">
                                                                                ...
                                                                                {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                    <button
                                                                                        key={filteredBtnIconDelete.id}
                                                                                        title='Delete'
                                                                                        onClick={() => warranty_delete(warranty.id)}
                                                                                        style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                                                                        className={filteredBtnIconDelete?.btn}
                                                                                    >
                                                                                        <a
                            ...
                            <div className=" d-flex justify-content-between">
                                ...
                                <div class="pagination float-right pagination-sm border">
                                    {
                                        currentPage - 3 >= 1 && (
                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/warranty/warranty_all?page=${1}`}>‹ First</Link>
                                        )
                                    }
                                    {
                                        currentPage > 1 && (
                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/warranty/warranty_all?page=${activePage - 1}`}>&lt;</Link>
                                        )
                                    }
                                    {
                                        pageNumber.map((page) =>
                                            <Link
                                                key={page}
                                                href={`/Admin/warranty/warranty_all?page=${page}`}
                                                className={` ${page === activePage ? "font-bold bg-primary px-2 border-left py-1 text-white" : "text-primary px-2 border-left py-1"}`}
                                            > {page}
                                            </Link>
                                        )
                                    ...
                                    {
                                        currentPage + 3 <= totalPages && (
                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/warranty/warranty_all?page=${totalPages}`}>Last ›</Link>
                                        )
                                    }
                                </div>
