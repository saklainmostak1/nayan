...
//   const {
//     data: newsCategoryAll = [],
//     isLoading,
//     refetch,
//   } = useQuery({
//     queryKey: ["newsCategoryAll"],
//     queryFn: async () => {
...
//     (moduleI) => moduleI.controller_name === "news_category"
//   );
...
//   const newsCategoryAll_delete = (id) => {
//     console.log(id);
//     const proceed = window.confirm(`Are You Sure delete${id}`);
//     if (proceed) {
//       fetch(
//         `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/news_category/news_category_delete/${id}`,
//         {
//           method: "POST",
//         }
//       )
...
//                           </div>
//                         ) : (
//                           newsCategoryAll.map((newsCategoryAll, i) => (
//                             <tr key={newsCategoryAll.id}>
//                               <td>{newsCategoryAll?.name}</td>
//                               <td>
//                                 {newsCategoryAll?.status === 1
//                                   ? "Active"
//                                   : "Inactive"}
//                               </td>
//                               <td>{newsCategoryAll?.author_name}</td>

//                               <td>
//                                 {newsCategoryAll?.created_date
//                                   ? formatDateTime(newsCategoryAll.created_date)
//                                   : ""}
//                               </td>
...
//                                   <Link
//                                     href={`/Admin/news_category/news_category_edit/${newsCategoryAll.id}?page_group=${page_group}`}
//                                   >
...
//                                   </Link>
//                                   <Link
//                                     href={`/Admin/news_category/news_category_copy/${newsCategoryAll.id}?page_group=${page_group}`}
//                                   >
...
const NewsCategoryList = ({ searchParams }) => {
  const {
  ...
  const caregory_list = async () => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/news_category/news_category_list_paigination/${currentPage}/${dataPerPage}`;
                      ...
                      <div class="pagination float-right pagination-sm border">
                        {currentPage - 3 >= 1 && (
                          <Link
                            ...
                            href={`/Admin/news_category/news_category_all?page=${1}`}
                          >
                            ‹ First
                          </Link>
                        )}
                        ...
                        {currentPage + 3 <= totalPages && (
                          <Link
                            className=" text-primary px-2 border-left py-1"
                            href={`/Admin/news_category/news_category_all?page=${totalPages}`}
                          >
                            Last ›
                          </Link>
                        )}
                          ...
                          pageUsers.map((noticeCategoryAll, i) => (
                            <tr key={noticeCategoryAll.id}>
                              ...
                              <td>
                                <div className="flex items-center ">
                                  <Link
                                    href={`/Admin/news_category/news_category_edit/${noticeCategoryAll.id}?page_group=${page_group}`}
                                  >
                                    {filteredBtnIconEdit?.map(
                                      (filteredBtnIconEdit) => (
                                        <button
                                  ...
                                  <Link
                                    href={`/Admin/news_category/news_category_copy/${noticeCategoryAll.id}?page_group=${page_group}`}
                                  >
                                    {filteredBtnIconCopy.map(
                                      (filteredBtnIconEdit) => (
                                        <button
