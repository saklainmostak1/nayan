...
//                 mobile, amount, recharge_time, recharge_user, modified_by: localStorage.getItem('userId')
//             });
//         }
...
const MobileAllowanceEdit = ({ id }) => {
    ...
    useEffect(() => {
        if (mobileAllowanceSingle && mobileAllowanceSingle[0]) {
            ...
            setFormData({
                mobile, amount, recharge_time, recharge_user, branch_id, created_by: userId
            });
        }
