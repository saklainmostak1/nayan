...
const AssetEmployeeList = ({ searchParams }) => {
    ...
    const { data: asset_employeeAll = [], isLoading, refetch
    } = useQuery({
    ...
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'asset_employee')
    ...
    // Paigination start
    const parentUsers = asset_employeeAll
    ...
    const asset_employee_delete = id => {
                        ...
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Asset Employe Search</h5>
                                </div>
                                    ...
                                    <form >
                                        <div className="col-md-10 offset-md-1">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-form-label col-md-2"><strong>Asset:</strong></label>
                                                <div className="col-md-4">
                                                    <select
  ...
  <input
                    ...
                    <div className='card'>
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">List Asset Employe</h5>
                                    <div className="card-title font-weight-bold mb-0 card-header-color float-right">
                                        <Link href={`/Admin/asset_employee/asset_employee_create?page_group`} className="btn btn-sm btn-info">Asset Employee Create</Link>
                                    </div>
                                </div>
                                                        ...
                                                        <table className="table  table-bordered table-hover table-striped table-sm">
                                                            ...
                                                            <tbody>
                                                                {isLoading ? <div className='text-center'>
                                                                    ...
                                                                    :
                                                                    searchResults.map((asset_employee, i) => (
                                                                        <tr key={asset_employee.id}>
                                                                            <td>    {i + 1}</td>

                                                                            <td>
                                                                                {asset_employee?.full_name}
                                                                            </td>

                                                                            <td>
                                                                                {asset_employee.asset_name}
                                                                            </td>
                                                                            <td>
                                                                                {asset_employee.handover_date.slice(0, 10)}
                                                                            </td>

                                                                            <td>
                                                                                {asset_employee.return_date.slice(0, 10)}
                                                                            </td>
                                                                            <td>
                                                                                {asset_employee.note}
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div className="flex items-center ">
                                                                                    <Link href={`/Admin/asset_employee/asset_employee_edit/${asset_employee.id}?page_group=${page_group}`}>
                                                                                    ...
                                                                                    {/* <Link href={`/Admin/asset_employee/asset_employee_copy/${asset_employee.id}?page_group=${page_group}`}>
                                ...
                                ></a>
                                                                                    ...
                                                                                    {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                        <button
                                                                                            ...
                                                                                            title='Delete'
                                                                                            onClick={() => asset_employee_delete(asset_employee.id)}
                                                                                            style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                            ...
                                            <div className='table-responsive'>
                                                <div className=" d-flex justify-content-between">
                                                    ...
                                                    <div class="pagination float-right pagination-sm border">
                                                        {
                                                            currentPage - 3 >= 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_employee/asset_employee_all?page=${1}`}>‹ First</Link>
                                                            )
                                                        }
                                                        {
                                                            currentPage > 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_employee/asset_employee_all?page=${activePage - 1}`}>&lt;</Link>
                                                            )
                                                        }
                                                        {
                                                            pageNumber.map((page) =>
                                                                <Link
                                                                    key={page}
                                                                    href={`/Admin/asset_employee/asset_employee_all?page=${page}`}
                                                        ...
                                                        }
                                                        {
                                                            currentPage + 3 <= totalPages && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_employee/asset_employee_all?page=${totalPages}`}>Last ›</Link>
                                                            )
                                                        }
                                                    </div>
                                                ...
                                                <table className="table  table-bordered table-hover table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        {isLoading ? <div className='text-center'>
                                                            ...
                                                            :
                                                            pageUsers.map((asset_employee, i) => (
                                                                <tr key={asset_employee.id}>
                                                                    <td>    {i + 1}</td>
...
export default AssetEmployeeList;