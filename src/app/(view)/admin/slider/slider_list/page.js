...
const SliderList = ({ searchParams }) => {
    ...
    console.log(moduleInfo.filter(moduleI => moduleI.controller_name === 'slider'))
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'slider')
                    ...
                    children: [
                        ...
                        new TableCell({
                            children: [new Paragraph({
                                text: category.content_type == 1 ? 'Block & Custom Page' :
                                    category.content_type == 2 ? 'Only Block Link List' :
                                        category.content_type == 3 ? 'Image Block List' :
                                            category.content_type == 4 ? 'Icon Block List' : '' || ''
                            })], // Email
                                                    ...
                                                    <tbody>
                                                        {isLoading ? <div className='text-center'>
                                                            ...
                                                            searchResults.map((front, i) => (
                                                                <tr key={front.id}>
                                                                    <td>{i + 1}</td>
                                                                    <td>{front.slider_name}</td>
                                                                <td>
                                                                    {
                                                                        front.created_by
                                                                    }  <br />
                                                                    {
                                                                        front.created_date.slice(0, 10)
                                                                    }
                                                                </td>
                                                                    <td>
                                                                        <div className="flex items-center ">
                                                                            <Link href={`/Admin/slider/slider_edit/${front.id}?page_group=${page_group}`}>
                                                                            ...
                                                                            {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                <button
                                                                                    ...
                                                                                    title='Delete'
                                                                                    onClick={() => slider_delete(front.id)}
                                                                                    style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                    ...
                                    <div className='table-responsive'>
                                        <div className=" d-flex justify-content-between">
                                            ...
                                            <div class="pagination float-right pagination-sm border">
                                                {
                                                    currentPage - 3 >= 1 && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/slider/slider_all?page=${1}`}>‹ First</Link>
                                                    )
                                                }
                                                {
                                                    currentPage > 1 && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/slider/slider_all?page=${activePage - 1}`}>&lt;</Link>
                                                    )
                                                }
                                                {
                                                    pageNumber.map((page) =>
                                                        <Link
                                                            key={page}
                                                            href={`/Admin/slider/slider_all?page=${page}`}
                                                ...
                                                }
                                                {
                                                    currentPage + 3 <= totalPages && (
                                                        <Link className=" text-primary px-2 border-left py-1" href={`/Admin/slider/slider_all?page=${totalPages}`}>Last ›</Link>
                                                    )
                                                }
                                            </div>
