...
const StockDetails = () => {
    ...
    const stock_pdf_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/stock/stock_details_pdf`, {
                method: 'POST',
                headers: {
    ...
    const stock_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/stock/stock_details_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
