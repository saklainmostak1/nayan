...
const MaterialList = ({ searchParams }) => {
    ...
    console.log(moduleInfo.filter(moduleI => moduleI.controller_name === 'material'))
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'material')
    ...
    const Category = module_settings.filter(moduleI => moduleI.table_name === 'material')
    ...
    const columnNames = materials && materials.length > 0 ? Object.keys(materials[0]) : [];
    ...
    const material_column_change = (selectedItems) => {
    ...
    const material_excel_download = async () => {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/material/material_delete/${id}`)
                .then(response => {
                    ...
                    // Update the searchResults array by removing the deleted material
                    setSearchResults(prevResults => prevResults.filter(material => material.id !== id));
                })
                .catch(error => {
    ...
    const material_PDF_download = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Error generating PDF In material');
            }
                        ...
                        <div class=" body-content bg-light">
                            ...
                            <div class=" border-primary shadow-sm border-0">
                                <div class=" card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Material Search</h5>
                                    <div class="card-title font-weight-bold mb-0 card-header-color float-right">

                                        <Link href={`/Admin/material/material_create?page_group=${page_group}`} class="btn btn-sm btn-info">Back To Create Material</Link>
                                    </div>
                                </div>
                                    ...
                                    <form class="">
                                        <div class="col-md-10 offset-md-1">
                                            ...
                                            <div className='form-group row student'>
                                                <label class="col-form-label col-md-3"><strong>Material Name:</strong></label>
                                                <div class="col-md-3">
                                                    <input
                                                        value={searchQuery}
                                                        onChange={(e) => setSearchQuery(e.target.value)}
                                                        type="text" name="student_id" class="form-control form-control-sm  alpha_space student_id" id="student_id" placeholder="Material Name" />
                                                </div>
...
<input type="text" name="extra_column" class="form-control form-control-sm  alpha_space extra_column" id="extra_column" placeholder="Extra Column" />
                                            ...
                                            <div class="form-group row student">
                                                ...
                                                <div className="col-md-9">
                                                    ...
                                                    <Select
                                                        ...
                                                        onChange={material_column_change}
                                                    />
                                        ...
                                        <div class="form-group row">
                                            <div class="offset-md-2 col-md-12 float-left">
                                                <input type="button" onClick={material_search} name="search" class="btn btn-sm btn-info search_btn mr-2" value="Search" />
                                                <input type="button" onClick={material_print} name="search" class="btn btn-sm btn-success print_btn mr-2" value="Print" />
                                                <input style={buttonStyles} type="button" name="search" class="btn btn-sm btn-indigo pdf_btn mr-2" value="Generate PDF" onClick={material_PDF_download} />
                                                {errorr && <p>Error: {errorr}</p>}

                                                <input
                                                    type="button"
                                                    onClick={material_excel_download}
                                                    name="search"
                                                ...
                                                <input
                                                    type="button"
                                                    onClick={material_word_download}
                                                    name="search"
                                                    className="btn btn-sm btn-secondary excel_btn mr-2"
                                                    value="Download Docx"
                                                />
                    ...
                    <div className='card'>
                        <div class=" border-primary  shadow-sm border-0">
                            <div class="card-header   custom-card-header py-1  clearfix bg-gradient-primary text-white">
                                <h5 class="card-title card-header-color font-weight-bold mb-0  float-left mt-1">Material List</h5>
                                <div class="card-title card-header-color font-weight-bold mb-0  float-right"> <Link href={`/Admin/material/material_create?page_group=${page_group}`} class="btn btn-sm btn-info">Back To Create Material</Link> </div>
                            </div>
                                                    ...
                                                    {searchResults.map((material, i) => (
                                                        <tr key={i}>
                                                            {selectedColumns.map((column, j) => (
                                                                <td key={j} style={['material_name', 'description'].includes(column) ? longTextStyle : {}}>
                                                                    {column === 'serial' ? (
                                                                        // Rendering serial number if the column is 'serial'
                                                                        i + 1
                                                                    ) : column === 'file_path' ? (
                                                                        ...
                                                                        <>
                                                                            <img
                                                                                ...
                                                                                style={{ width: '100px' }}
                                                                                src={`${process.env.NEXT_PUBLIC_API_URL}:5003/${material.file_path}`}
                                                                                alt="No Image"
                                                                            />
                                                                        </>
                                                                    )
                                                                        ...
                                                                        column === 'status_id' ? (
                                                                            // Special handling for the 'status' column
                                                                            <>
                                                                                {material.status_id === 1 && <p>Active</p>}
                                                                                {material.status_id === 2 && <p>Inactive</p>}
                                                                                {material.status_id === 3 && <p>Pending</p>}
                                                                            </>
                                                                        )
                                                                            ...
                                                                            : column === 'action' ? (
                                                                                ...
                                                                                <div className="flex items-center ">
                                                                                    <Link href={`/Admin/material/material_edit/${material.id}?page_group=${page_group}`}>
                                                                                    ...
                                                                                    <Link href={`/Admin/material/material_copy/${material.id}?page_group=${page_group}`}>
                                                                                    ...
                                                                                    {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                        <button
                                                                                            ...
                                                                                            title='Delete'
                                                                                            onClick={() => material_delete_searching(material.id)}
                                                                                            style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                        ...
                                        <>
                                                ...
                                                <table className="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        {pageUsers.length === 0 ? (
                                                            ...
                                                            pageUsers?.map((material, index) => (
                                                                <tr key={material.id}>
                                                                    {selectedColumns?.map(column => (
                                                                        <td key={column} style={['material_name', 'description'].includes(column) ? longTextStyle : {}}>
                                                                            {column === 'serial' ? (
                                                                                        ...
                                                                                        <div className="flex items-center ">
                                                                                            ...
                                                                                            {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                                <button
                                                                                                    key={filteredBtnIconDelete.id}
                                                                                                    title='Delete'
                                                                                                    onClick={() => material_delete(material.id)}
                                                                                                    style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                                                                                    className={filteredBtnIconDelete?.btn}
                                                                                                >
                                                                                                    <a
                                            ...
                                            <div className=" d-flex justify-content-between">
                                                ...
                                                <div class="pagination float-right pagination-sm border">
                                                    {
                                                        currentPage - 3 >= 1 && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/material/material_all?page=${1}`}>‹ First</Link>
                                                        )
                                                    }
                                                    {
                                                        currentPage > 1 && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/material/material_all?page=${activePage - 1}`}>&lt;</Link>
                                                        )
                                                    }
                                                    {
                                                        pageNumber.map((page) =>
                                                            <Link
                                                                key={page}
                                                                href={`/Admin/material/material_all?page=${page}`}
                                                                className={` ${page === activePage ? "font-bold bg-primary px-2 border-left py-1 text-white" : "text-primary px-2 border-left py-1"}`}
                                                            > {page}
                                                            </Link>
                                                        )
                                                    ...
                                                    {
                                                        currentPage + 3 <= totalPages && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/material/material_all?page=${totalPages}`}>Last ›</Link>
                                                        )
                                                    }
                                                </div>
...
//                                         />
//                                     </div>
//                                     <label class="col-form-label col-md-2"><strong>Material Name:</strong></label>
//                                     <div class="col-md-4">
//                                         <input
//                                             value={searchQuery}
//                                             onChange={(e) => setSearchQuery(e.target.value)}
...
//                                     <label className="col-form-label col-md-2"><strong>Extra Column:</strong></label>
//                                     <div className="col-md-4">
//                                         <select name="extra_column" className="form-control form-control-sm alpha_space extra_column" id="extra_column" placeholder="Extra Column">
//                                             {(() => {
//                                                 const options = [];
