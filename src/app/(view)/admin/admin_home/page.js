      ...
      <div class="row">
        <div className='col-12 p-4'>
          <div className='card border-0'>
            {/* main-container  */}
            <div className='main-cards mt-0 mt-lg-0 mt-md-0 '>

              <div className="card1 h-100 mb-4 shadow-sm bg-gradient-success">
              ...
              <div className="card2 h-100 mb-4 shadow-sm bg-gradient-info">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  <div className="col-4 align-self-center rounded-circle float-left">
                    <div className="card card-block border-0 bg-transparent d-flex align-items-center justify-content-center">
              ...
              <div className="card3 h-100 mb-4 shadow-sm bg-gradient-warning">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  <div className="col-4 align-self-center rounded-circle float-left">
                    <div className="card card-block border-0 bg-transparent d-flex align-items-center justify-content-center">
              ...
              <div className="card4 h-100 mb-4 shadow-sm bg-gradient-danger">
                <div className="card-body p-2 d-flex justify-content-between align-items-center">
                  <div className="col-4 align-self-center rounded-circle float-left">
                    <div className="card card-block border-0 bg-transparent d-flex align-items-center justify-content-center">
...
//     setTimeout(() => {
//       setLoading(false);
//     }, 500); // Change this time to simulate different loading durations
//   }, []);
...
//       {...props}
//     >
//       <rect x="68" y="37" rx="3" ry="3" width="258" height="129" />
//       <rect x="426" y="37" rx="3" ry="3" width="258" height="129" />
//       <rect x="786" y="37" rx="3" ry="3" width="258" height="129" />
