...
export default function AdminPageListC() {
    ...
    const module_info_create = (event) => {
                            ...
                            <div className='mb-3'>
                                <li className="list-group-item text-light  p-1 px-4 " aria-current="true" style={{ background: '#4267b2' }}>
                                    <div className='d-flex justify-content-between'>
                                        <h5>Module Info Create </h5>
                                        <button style={{ background: '#17a2b8' }} className='border-0 text-white shadow-sm rounded-1'>
                                            <Link href={`/Admin/module_info/module_info_all`}>Back To Module Info List</Link>
                                        </button>
                                    </div>
                                ...
                                <button style={{ background: '#17a2b8' }} className='border-0 text-white shadow-sm rounded-1'>
                                    ...
                                    <section className=" border  rounded mx-auto">
                                        ...
                                        <div className="card-body">
                                            <form className="form-horizontal" autoComplete="off" onSubmit={module_info_create}>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                <option defaultValue="certificate">purchase</option>
