...
// const PhotoGelleryCategoryList = () => {
//   const {
...
//                                 <td>
//                                   {photogalleryCategoryAll?.status === 1
//                                     ? "Active"
//                                     : "Inactive"}
//                                 </td>
...
//                                     <Link
//                                       href={`/Admin/events_category/events_category_edit/${photogalleryCategoryAll.id}?page_group=${page_group}`}
//                                     >
...
//                                     </Link>
//                                     <Link
//                                       href={`/Admin/events_category/events_category_copy/${photogalleryCategoryAll.id}?page_group=${page_group}`}
//                                     >
...
// export default PhotoGelleryCategoryList;
...
const PhotoGelleryCategoryList = ({ searchParams }) => {
  const {
  ...
  //   // প্রথমে কনফার্মেশন ডায়ালগ দেখান
  //   const proceed = window.confirm(`Are you sure delete this item.`);

  //   // যদি ইউজার `OK` ক্লিক করে তবেই ডিলিট রিকোয়েস্ট পাঠান
  //   if (proceed) {
  //     try {
  ...
  //         refetch(); // ডাটা রিফ্রেশ করুন
  //         caregory_list(); // ক্যাটেগরি লিস্ট আপডেট করুন
  //       } else {
                      ...
                      <div class="pagination float-right pagination-sm border">
                        {currentPage - 3 >= 1 && (
                          <Link
                            ...
                            href={`/Admin/events_category/events_category_all?page=${1}`}
                          >
                            ‹ First
                          </Link>
                        )}
                        ...
                        {currentPage + 3 <= totalPages && (
                          <Link
                            className=" text-primary px-2 border-left py-1"
                            href={`/Admin/events_category/events_category_all?page=${totalPages}`}
                          >
                            Last ›
                          </Link>
                        )}
