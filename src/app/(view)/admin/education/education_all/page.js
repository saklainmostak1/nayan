...
const EducationList = ({ searchParams }) => {
  const {
  ...
  const brandList = moduleInfo.filter(
    (moduleI) => moduleI.controller_name === "education"
  );
                      ...
                      <div class="pagination float-right pagination-sm border">
                        {currentPage - 3 >= 1 && (
                          <Link
                            ...
                            href={`/Admin/education/education_all?page=${1}`}
                          >
                            ‹ First
                          </Link>
                        )}
                        ...
                        {currentPage + 3 <= totalPages && (
                          <Link
                            className=" text-primary px-2 border-left py-1"
                            href={`/Admin/education/education_all?page=${totalPages}`}
                          >
                            Last ›
                          </Link>
                        )}
                        ...
                        {isLoading ? (
                          ...
                          pageUsers.map((photogalleryCategoryAll, i) => (
                            <tr key={photogalleryCategoryAll.id}>
                              <td>{photogalleryCategoryAll?.education_name}</td>
                              ...
                              <td>
                                <div className="flex items-center ">
                                  <Link
                                    href={`/Admin/education/education_edit/${photogalleryCategoryAll.id}?page_group=${page_group}`}
                                  >
