...
const PopUpCreates = () => {
    ...
    const front_service_box_create = (event) => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/pop_up/pop_up_create`, {
            method: 'POST',
            headers: {
                'content-type': 'application/json',
            },
        ...
        <div class="col-md-12 bg-light p-4">
            <div class="card border-primary shadow-sm border-0">
                <div class="card-header py-1  clearfix bg-gradient-primary text-white">
                    <h5 class="card-title font-weight-bold mb-0  float-left mt-1">Create Pop Up</h5>
                        ...
                        <div class="form-group row">
                            ...
                            {/* <div class="col-md-4">
                                <div class="form-check form-check-inline mt-2">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="pop_up_align" onChange={handleInputChanges} value={formData.pop_up_align} />
                                    <label class="form-check-label" for="autoSizingCheck">
                                        Window Center
                                    </label>
                                </div>
                                <div class="form-check form-check-inline  mt-2">
                                    <input onChange={handleInputChanges} value={formData.pop_up_scrollable} class="form-check-input" type="checkbox" name="pop_up_scrollable" />
                                    <label class="form-check-label" for="autoSizingCheck">
                                        Scrollable Content
                                    </label>
                                </div>
