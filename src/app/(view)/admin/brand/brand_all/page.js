...
const BrandList = ({ searchParams }) => {
    ...
    const brand_search = () => {
        ...
        if (!(multiSearch || searchQuery || statusFilter || selectedOrder || fromDate || toDate)) {
                ...
                selectedColumns.forEach(column => {
                    if (column !== 'action') {
                        ...
                        if (column === 'file_path') {
                            ...
                            console.log(`${process.env.NEXT_PUBLIC_API_URL}:5003/${category.file_path}`)
    ...
    const brand_excel_download = async () => {
        ...
        try {
            ...
            XLSX.writeFile(workbook, 'brand_results.xlsx');
        } catch (error) {
        ...
        if (proceed) {
            axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/brand/brand_delete/${id}`)
                .then(response => {
                    ...
                    // Update the searchResults array by removing the deleted warranty
                    setSearchResults(prevResults => prevResults.filter(warranty => warranty.id !== id));
                })
                .catch(error => {
                            ...
                            <div class="card-body">
                                <form class="">
                                    <div class="col-md-10 offset-md-1">
                                        ...
                                        <div class="form-group row student">
                                            <label class="col-form-label col-md-3"><strong>Brand Name:</strong></label>
                                            <div class="col-md-3">
                                                <input
                                                    value={searchQuery}
                                                    onChange={(e) => setSearchQuery(e.target.value)}
                                                    type="text" name="student_id" class="form-control form-control-sm  alpha_space student_id" id="student_id" placeholder="Brand Name" />
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-md-2 col-md-10 float-left">
                                            ...
                                            <input type="button" onClick={brand_print} name="search" class="btn btn-sm btn-success print_btn mr-2" value="Print" />

                                            <input style={buttonStyles} type="button" name="search" class="btn btn-sm btn-indigo pdf_btn mr-2" value="Generate PDF" onClick={brand_PDF_download} />
                                            ...
                                            <input
                                                ...
                                                onClick={clearSearch}
                                                name="Clear"
                                                className="btn btn-sm btn-danger excel_btn mr-2"
                                                value="Clear Search"
                                            />
                    ...
                    <div className='card'>
                        <div class=" border-primary  shadow-sm border-0">
                            <div class="card-header   custom-card-header py-1  clearfix bg-gradient-primary text-white">
                                <h5 class="card-title card-header-color font-weight-bold mb-0  float-left mt-1">Brand List</h5>
                                <div class="card-title card-header-color font-weight-bold mb-0  float-right">
                                    <Link href={`/Admin/brand/brand_create?page_group=${page_group}`} class="btn btn-sm btn-info">Create Brand</Link> </div>
                            </div>
                                                                    ...
                                                                    {column === 'serial' ? (
                                                                        ...
                                                                        <>
                                                                            <img
                                                                                ...
                                                                                style={{ width: '100px' }}
                                                                                src={`${process.env.NEXT_PUBLIC_API_URL}:5003/${brand.file_path}`}
                                                                                alt="No Image"
                                                                            />
                                                                        </>
                                                                    )
                                                                        ...
                                                                        column === 'status_id' ? (
                                                                            // Special handling for the 'status' column
                                                                            <>
                                                                                {brand.status_id === 1 && <p>Active</p>}
                                                                                {brand.status_id === 2 && <p>Inactive</p>}
                                                                                {brand.status_id === 3 && <p>Pending</p>}
                                                                            </>
                                                                        )
                                                                            ...
                                                                            : column === 'action' ? (
                                                                                ...
                                                                                <div className="flex items-center ">
                                                                                    <Link href={`/Admin/brand/brand_edit/${brand.id}?page_group=${page_group}`}>
                                                                                    ...
                                                                                    <Link href={`/Admin/brand/brand_copy/${brand.id}?page_group=${page_group}`}>
                                                                                    ...
                                                                                    {filteredBtnIconDelete.map((filteredBtnIconDelete => (
                                                                                        <button
                                                                                            ...
                                                                                            title='Delete'
                                                                                            onClick={() => brand_delete_searching(brand.id)}
                                                                                            style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
                                        ...
                                        <>
                                            <div className=" d-flex justify-content-between mb-2">
                                                ...
                                                <div class="pagination float-right pagination-sm border">
                                                    {
                                                        currentPage - 3 >= 1 && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/brand/brand_all?page=${1}`}>‹ First</Link>
                                                        )
                                                    }
                                                    {
                                                        currentPage > 1 && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/brand/brand_all?page=${activePage - 1}`}>&lt;</Link>
                                                        )
                                                    }
                                                    {
                                                        pageNumber.map((page) =>
                                                            <Link
                                                                key={page}
                                                                href={`/Admin/brand/brand_all?page=${page}`}
                                                    ...
                                                    }
                                                    {
                                                        currentPage + 3 <= totalPages && (
                                                            <Link className=" text-primary px-2 border-left py-1" href={`/Admin/brand/brand_all?page=${totalPages}`}>Last ›</Link>
                                                        )
                                                    }
                                                </div>
                                                ...
                                                <table className="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        {pageUsers.length === 0 ? (
                                                            ...
                                                            pageUsers?.map((brand, index) => (
                                                                <tr key={brand.id}>
                                                                    {selectedColumns?.map(column => (
                                                                        <td key={column} style={['brand_name', 'description'].includes(column) ? longTextStyle : {}}>
                                                                            {column === 'serial' ?
                                                                                ...
                                                                                column === 'file_path' ? (
                                                                                    ...
                                                                                    column === 'status_id' ? (
                                                                                        brand[column] === 1 ? 'Active' : brand[column] === 2 ? 'Inactive' : brand[column] === 3 ? 'Pending' : 'Unknown'
                                                                                    )
                                                                                        :
                                                                                        column === 'action' ? (
                                                                                            <div className="flex items-center ">
...
//     const filteredBtnIconDelete = brandList.filter(btn => btn.method_sort === 5);
//     const filteredBtnIconCreate = brandList.filter(btn => btn.method_sort === 1);

//     const Category = module_settings.filter(moduleI => moduleI.table_name === 'brand');
//     const columnListSelected = Category[0]?.column_name;
//     const columnListSelectedSearch = Category[0]?.search;
//     const columnListSelectedArray = columnListSelected?.split(',').map(item => item.trim());
//     const columnListSelectedSearchArray = columnListSelectedSearch?.split(',').map(item => item.trim());
...
//     useEffect(() => {
//         const savedSearchState = JSON.parse(localStorage.getItem('brandSearchState'));
//         if (savedSearchState) {
//             setSearchQuery(savedSearchState.searchQuery);
//             setStatusFilter(savedSearchState.statusFilter);
//             setSelectedOrder(savedSearchState.selectedOrder);
//             setFromDate(savedSearchState.fromDate);
//             setToDate(savedSearchState.toDate);
//             setSelectedColumns(savedSearchState.selectedColumns);
//             setSelectedColumnsSearch(savedSearchState.selectedColumnsSearch);
//             setSearchResults(savedSearchState.searchResults);
//         } else {
//             setSelectedColumns(columnListSelectedArray);
//             setSelectedColumnsSearch(columnListSelectedSearchArray);
//         }
//     }, []);
...
//                     alert('Nothing found!');
//                 }
//                 // localStorage.setItem('brandSearchState', JSON.stringify({
//                 //     searchQuery,
//                 //     statusFilter,
//                 //     selectedOrder,
//                 //     fromDate,
...
//     const brand_column_changes = (selectedItems) => {
//         setSelectedColumnsSearch(selectedItems.map((item) => item.value));
//     };
...
//         setSelectedColumnsSearch(columnListSelectedSearchArray);
//         setSearchResults([]);
//         localStorage.removeItem('brandSearchState');
//     };
...
//                             <div className="bg-gradient-primary card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
//                                 <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Brand Search</h5>
//                                 <div className="card-title font-weight-bold mb-0 card-header-color float-right">
//                                     <Link href={`/Admin/brand/brand_create?page_group=${page_group}`} className="btn btn-sm btn-primary">
//                                         <i className="fas fa-plus"></i> {filteredBtnIconCreate[0]?.name}
//                                     </Link>
//                                 </div>
//                             </div>
...
//                                         <label htmlFor="fromDate" className="form-label font-weight-bold">From Date</label>
//                                         <DatePicker
//                                             id="fromDate"
//                                             selected={fromDate}
...
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="toDate" className="form-label font-weight-bold">To Date</label>
//                                         <DatePicker
//                                             id="toDate"
//                                             selected={toDate}
...
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="searchQuery" className="form-label font-weight-bold">Search</label>
//                                         <input
//                                             type="text"
//                                             id="searchQuery"
//                                             value={searchQuery}
...
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="statusFilter" className="form-label font-weight-bold">Status</label>
//                                         <select
//                                             id="statusFilter"
//                                             value={statusFilter}
...
//                                             <option value="">Select Status</option>
//                                             {status.map(stat => (
//                                                 <option key={stat.id} value={stat.status_name}>{stat.status_name}</option>
//                                             ))}
//                                         </select>
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="selectedOrder" className="form-label font-weight-bold">Order By</label>
//                                         <select
//                                             id="selectedOrder"
//                                             value={selectedOrder}
...
//                                             <option value="brand_id (ASC)">ID Ascending</option>
//                                             <option value="brand_id (DESC)">ID Descending</option>
//                                             <option value="brand_name (ASC)">Brand Ascending</option>
//                                             <option value="brand_name (DESC)">Brand Descending</option>
//                                         </select>
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="selectedColumns" className="form-label font-weight-bold">Search Columns</label>
//                                         <Select
//                                             id="selectedColumns"
//                                             options={matched?.map(column => ({
//                                                 label: formatString(column),
//                                                 value: column
//                                             }))}
//                                             values={selectedColumnsSearch?.map(column => ({
//                                                 label: formatString(column),
//                                                 value: column
//                                             }))}
//                                             onChange={brand_column_changes}
...
//                                     </div>
//                                     <div className="col-md-3 mb-3">
//                                         <label htmlFor="selectedColumnsView" className="form-label font-weight-bold">Columns to View</label>
//                                         <Select
//                                             id="selectedColumnsView"
//                                             options={matched?.map(column => ({
//                                                 label: formatString(column),
//                                                 value: column
//                                             }))}
//                                             values={selectedColumns?.map(column => ({
//                                                 label: formatString(column),
//                                                 value: column
//                                             }))}
//                                             onChange={brand_column_change}
...
//                                         <button type="button" className="btn btn-primary" onClick={brand_search}>
//                                             Search
//                                             {loading && (
...
//                         <div className="border-primary shadow-sm border-0">
//                             <div className="bg-gradient-primary card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
//                                 <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Brand List</h5>
//                             </div>
//                             <div className="card-body">
...
//                                                     <th key={btn.id} className="text-center">Edit</th>
//                                                 ))}
//                                                 {filteredBtnIconDelete?.map(btn => (
//                                                     <th key={btn.id} className="text-center">Delete</th>
//                                                 ))}
//                                             </tr>
//                                         </thead>
//                                         <tbody>
...
//                                                 <tr key={index}>
//                                                     {selectedColumns?.map(column => (
//                                                         <td key={column} style={longTextStyle}>{brand[column]}</td>
//                                                     ))}
//                                                     {filteredBtnIconEdit?.map(btn => (
//                                                         <td key={btn.id} className="text-center">
//                                                             <Link href={`/Admin/brand/brand_edit/${brand.brand_id}?page_group=${page_group}`} className="btn btn-sm btn-primary">Edit</Link>
//                                                         </td>
//                                                     ))}
//                                                     {filteredBtnIconDelete?.map(btn => (
//                                                         <td key={btn.id} className="text-center">
//                                                             <button className="btn btn-sm btn-danger" onClick={() => brand_delete_searching(brand.brand_id)}>Delete</button>
//                                                         </td>
//                                                     ))}
//                                                 </tr>
//                                             ))}
