                    ...
                    <div className='card'>
                        <div class=" border-primary shadow-sm border-0">
                            <div class="card-header py-1  custom-card-header clearfix bg-gradient-primary text-white">
                                <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Update Loan</h5>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    {assetInfo.loan_reason.length > 255 && (
                                                        <p className='text-danger'>Loan Reason name cannot more than 255 characters.</p>
                                                    )}
                                                    {
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number"
                                                        readOnly
                                                        name="payable_amount" value={assetInfo.payable_amount} onChange={brand_input_change}
                                                        class="form-control form-control-sm  required "
