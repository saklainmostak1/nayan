...
const SettingsModel = () => {
    ...
    const model = module_settings.filter(moduleI => moduleI.table_name === 'model')
    const columnListSelected = model[0]?.column_name
    ...
    const model_column_change = (selectedItems) => {
    ...
    const model_settings_create = (event) => {
                        ...
                        <div class="body-content bg-light">
                            ...
                            <div class=" border-primary shadow-sm border-0">
                                <div class=" card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Model Settings</h5>
                                ...
                                <div class="card-body">
                                    <form onSubmit={model_settings_create}>
                                        <div class="col-md-9 offset-md-1">
                                            <div class="form-group row student d-none">
                                                ...
                                                <div class="col-md-4">
                                                    <input
                                                        defaultValue={model[0]?.table_name}
