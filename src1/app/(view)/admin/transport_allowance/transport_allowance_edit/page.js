...
//         }
//     };
//     console.log(transportAllowanceSingle)
...
//                                 <h5 className="card-title card-header-period font-weight-bold mb-0  float-left mt-1">Transport Allowance  Edit </h5>
...
// export default TransportAllowanceEdit;
...
const TransportAllowanceEdit = ({ id }) => {
    ...
    const router = useRouter()
    const [formData, setFormData] = useState({
        travel_from: '', travel_from_time: '', travel_to: '', travel_to_time: '', vehicle_name: '', km_travel: '', amount: '', user_id: leaveFor || modified_by, modified_by: modified_by, branch_id: ''
    ...
    useEffect(() => {
        if (transportAllowanceSingle && transportAllowanceSingle[0]) {
            ...
            setFormData({
                ...
                travel_from, travel_from_time, travel_to, travel_to_time, vehicle_name, km_travel, amount, modified_by: localStorage.getItem('userId'), user_id, branch_id
            });
        }
    }, [transportAllowanceSingle, modified_by]);
