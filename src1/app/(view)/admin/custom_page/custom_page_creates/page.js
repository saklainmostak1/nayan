...
import IconModalCustomBox from './modal';


const CustomPageCreates = () => {
...
const custom_page_create = (event) => {
        ...
        <div class="col-md-12 bg-light p-4">
            <div class="card border-primary shadow-sm border-0">
                <div class="card-header py-1  clearfix bg-gradient-primary text-white">
                    <h5 class="card-title font-weight-bold mb-0  float-left mt-1">Create Custom Page</h5>
                ...
                <div class="alert alert-warning mb-0 mx-4 mt-4 text-danger font-weight-bold" role="alert">
                    ...
                    <form class="" method="post" autocomplete="off" onSubmit={custom_page_create}>
                        <div className="form-group row">
...
export default CustomPageCreates;

// 'use client' 
 //ismile
// import IconModal from '@/app/(view)/admin_layout/modal/iconModal/page';
...
//         const extension = file.name.split('.').pop();
//         const newName = `${fileName}(${key}).${extension}`;
//         const filePath = `type/${year}/${month}/${day}/${hours}/${minutes}/${newName}`;
...
//         axios
//             .post(`${process.env.NEXT_PUBLIC_API_URL}:5003/type/type_image`, formData)
//             .then((res) => {
//                 console.log('File uploaded successfully:', res.data);
//             })
//             .catch((error) => {
...
//                                     <select
//                                         className="form-control form-control-sm"
//                                         value={linkData2[key].align}
//                                         onChange={(e) => handleInputChange2(key, 'align', e.target.value)}
//                                     >
//                                         <option value="">Button Center</option>
//                                         <option value="float-left">Button Left Align</option>
//                                         <option value="float-right">Button Right Align</option>
...
//                                 <div class="form-group row block_div2">
//                                     <label class="col-form-label font-weight-bold col-md-3">Links Name &amp; URL: <i class="fas fa-info-circle text-info " data-container="body" data-toggle="popover" data-placement="top" data-content="Summary  text and Image will be used in block" data-original-title="" title=""></i> :</label>
//                                     <div class="col-md-12">
//                                         <div class="card border-light">
//                                             <div class="card-header py-1 clearfix  bg-gradient-primary text-white">
//                                                 <div class="card-title font-weight-bold mb-0  float-left mt-1">Box Effect</div>
//                                                 <div class="card-title font-weight-bold mb-0 float-right">
//                                                     <div class="input-group input-group-sm">
//                                                         <input style={{ width: '40px' }} type="text" class="form-control add_text" value="1" />
...
//                                                                 style={{ flex: '1' }}
//                                                                 className="form-control form-control-sm name_input"
//                                                                 value={linkData['link1'].name}
//                                                                 onChange={(e) => handleInputChange('link1', 'name', e.target.value)}
//                                                                 placeholder="Name"
//                                                             />
...
//                                                                 style={{ flex: '1' }}
//                                                                 className="form-control form-control-sm link_type"
//                                                                 value={linkData['link1'].align}
//                                                                 onChange={(e) => handleInputChange('link1', 'align', e.target.value)}
//                                                             >
//                                                                 <option value="">Button Center</option>
//                                                                 <option value="float-left">Button Left Align</option>
//                                                                 <option value="float-right">Button Right Align</option>
...
//                                                                 style={{ flex: '1' }}
//                                                                 className="form-control form-control-sm link_type"
//                                                                 value={linkData['link1'].type}
//                                                                 onChange={(e) => handleSelectChange('link1', e.target.value)}
//                                                             >
//                                                                 <option value="1">External</option>
//                                                                 <option value="2">Front page</option>
//                                                                 <option value="3">No Link</option>
...
//                                                                 type="text"
//                                                                 className="form-control form-control-sm select_result"
//                                                                 value={linkData['link1'].value}
//                                                                 disabled={linkData['link1'].disabled}
//                                                                 onChange={(e) => handleInputChange('link1', 'value', e.target.value)}
//                                                             />
//                                                             {
//                                                                 linkData['link1'].type == '4' &&


//                                                                 <div className="input-group-append"  >
//                                                                     <span
//                                                                         className="input-group-text search_icon"
//                                                                         data-toggle={linkData['link1'].type === '4' ? 'modal' : ''}
//                                                                         data-target={linkData['link1'].type === '4' ? '#exampleModal' : ''}
//                                                                         onClick={() => linkData['link1'].type === '4' && openModal('link1')}
//                                                                     >
//                                                                         <i className="fas fa-search"></i>
//                                                                     </span>
//                                                                 </div>
...
//     // Open modal for content reference
//     const [modalData1, setModalData1] = useState({ id: '', value: '' });
//     const [activeTabs, setActiveTabs] = useState([]); // Manage multiple active tabs
//     const [pageListTable, setPageListTable] = useState('');
//     const [tableData, setTableData] = useState([]);

//     // Handle input change for linkData1


//     // Open the modal when a search item is clicked
//     const openModal = (id) => {
//         if (linkData1[id].type === '4') {
//             setModalData1({ id, value: linkData1[id].value });
//             $('#exampleModal').modal('show'); // Ensure modal shows when opened
...
//                         'Content-Type': 'application/json',
//                     },
//                     body: JSON.stringify({ pageListTable }),
//                 });
...
//     // Handle tab click (open the appropriate content)
//     const handleTabClick = (tabName, tabNames) => {
//         setActiveTabs([tabName, tabNames]);
//     };

//     console.log(linkData1)

//     // Modal Component for the content reference
...
// const YourComponent = () => {
//     const [inputs, setInputs] = useState([1]); // Start with one input field
//     const [linkData, setLinkData] = useState({
//         link1: { type: '1', value: 'https//', disabled: false, name: '', align: '' }
//     });
...
//     const handleInputChange = (id, key, value) => {
//         // Update only the specific field for the given input (id)
//         setLinkData((prevState) => ({
//             ...prevState,
//             [id]: {
//                 ...prevState[id],
...
//             const newInputId = prevInputs.length + 1; // Create a new unique input id
//             return [...prevInputs, newInputId]; // Add new input id to the list
//         });

//         // Add new entry in linkData for the new input field
//         setLinkData((prevLinkData) => ({
//             ...prevLinkData,
//             [`link${inputs.length + 1}`]: { type: '1', value: 'https//', disabled: false, name: '', align: '' }
//         }));
//     };
...
//                     <div className="card border-light">
//                         <div className="card-header py-1 clearfix">
//                             <div className="card-title font-weight-bold mb-0 float-left">Box Effect</div>
//                             <div className="card-title font-weight-bold mb-0 float-right">
//                                 <button type="button" onClick={handleAddMore} className="btn btn-info btn-sm">Add More</button>
//                             </div>
//                         </div>
//                         <div className="card-body">
//                             <div className="form-group row">
//                                 <div className="col-md-12">
//                                     {inputs.map((inputId) => (
//                                         <div key={inputId} className="input-group input-group-sm mb-2">
//                                             {/* Name input field */}
//                                             <input
//                                                 type="text"
//                                                 className="form-control"
//                                                 value={linkData[`link${inputId}`]?.name || ''}
//                                                 onChange={(e) => handleInputChange(`link${inputId}`, 'name', e.target.value)}
//                                                 placeholder="Name"
//                                             />
...
//                                             <select
//                                                 className="form-control"
//                                                 value={linkData[`link${inputId}`]?.align || ''}
//                                                 onChange={(e) => handleInputChange(`link${inputId}`, 'align', e.target.value)}
//                                             >
//                                                 <option value="">Button Center</option>
//                                                 <option value="float-left">Button Left Align</option>
//                                                 <option value="float-right">Button Right Align</option>
...
//                                             <select
//                                                 className="form-control"
//                                                 value={linkData[`link${inputId}`]?.type || ''}
//                                                 onChange={(e) => handleSelectChange(`link${inputId}`, e.target.value)}
//                                             >
//                                                 <option value="1">External</option>
//                                                 <option value="2">Front page</option>
//                                                 <option value="3">No Link</option>
...
//                                                 type="text"
//                                                 className="form-control"
//                                                 value={linkData[`link${inputId}`]?.value || ''}
//                                                 disabled={linkData[`link${inputId}`]?.disabled}
//                                                 onChange={(e) => handleInputChange(`link${inputId}`, 'value', e.target.value)}
//                                             />
//                                         </div>
//                                     ))}
//                                 </div>
