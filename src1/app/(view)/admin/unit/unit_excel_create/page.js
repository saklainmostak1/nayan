...
const CreateUnitExcel = () => {
    ...
    //         anchor.href = url;
    //         anchor.download = "Unit Excel Form.xlsx";
    //         anchor.click();
                            ...
                            {/* <div class="form-group row ml-2">
                                <div class="col-md-6 ">
                                    <span className=" mb-2 mt-2">
                                        ...
                                        <input className='mb-0' type="file" multiple accept=".xlsx, .xls" onChange={unit_file_upload} id={`fileInput`} style={{ display: "none" }} />
                                    </span>
                                    <span className=" mb-2 mt-2 ml-3">
                                        ...
                                        <input onClick={unit_excel_file_export} type="button" name="search" class="btn btn-sm btn-secondary excel_btn ml-2" id={`fileInpu`} style={{ display: "none" }} />
                                    </span>
                                </div>
                            </div> */}
                            <div class="col-md-9 offset-md-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small><span className='text-danger font-weight-bold'>***</span>Download unit Excell Format. Fill up with unit information and upload this file to quick data entry. </small>
                                    </div>
                                </div>
...
export default CreateUnitExcel;