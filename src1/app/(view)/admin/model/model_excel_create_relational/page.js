...
const ModelExcelCreateRelational = () => {
    ...
    //     const rolePermissionResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/brand/brand_all`);
...
export default ModelExcelCreateRelational;