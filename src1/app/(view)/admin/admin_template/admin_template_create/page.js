...
import { FaAngleDown, FaAngleRight, FaBars, FaCaretDown, FaEdit, FaSearch, FaTasks, FaTimes, FaUpload, FaUserGraduate } from 'react-icons/fa';
...
import AdminTemplateMenu from '../../admin_template_menu/create_admin_template_menu/page';
...
const AdminTemplateCreate = () => {
	...
	const admin_template_image_remove = () => {
	...
	const admin_template_create = async (event) => {
	...
	const [selectedMenu, setSelectedMenu] = useState('left_menu');
			...
			<div class=" row ">
				<div className='col-12 p-4'>
							...
							<div className='   border-primary shadow-sm border-0' >
								<div class="card-header  custom-card-header py-1  clearfix  bg-gradient-primary border-0 text-white" style={{ background: 'linear-gradient(to right, rgba( 66,103,178,1 ), rgba( 66,103,178,1 ))' }}>
									...
									<div class="card-title font-weight-bold mb-0 float-right">
										<Link href={`/Admin/admin_template/admin_template_all?page_group=${page_group}`} class="btn btn-sm btn-info">Back to Admin panel settings List</Link>
									</div>
								</div>
					...
					></AdminTemplateMenu> */}
									...
									<form action="" onSubmit={admin_template_create}>
										<div className=' mt-4 '>
									...
									<div className="custom-control custom-switch">
										...
										<label className="custom-control-label font-weight-bold" htmlFor="customSwitch1">
											...
											<div>
												...
												<div class="form-group row px-4">
													<label class="control-label font-weight-bold col-md-3">Select Menu:</label>
													<div class="col-md-4">
														<div class="input-group input-group-sm mb-3">
															...
															<select
																...
																required="" class="form-control form-control-sm custom-select trim" placeholder="Enter Expense Category">
																<option value="left_menu">Left Menu</option>
																<option value="toggle_menu">Toggle Menu</option>
												...
												{selectedMenu === 'toggle_menu' && (

													<div className='ml-2'>

														<p>
															<label class="control-label font-weight-bold col-md-4 col-5">Toggle Menu</label>
															<button style={{ color: '#fff', background: '#4267b2', borderColor: '#4267b2', }} className="btn btn-sm btn-secondary icon_modal" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
												...
												{/* <label class="control-label font-weight-bold col-md-3">Toggle Menu</label>
...
<button
        style={{ color: '#fff', background: '#4267b2', borderColor: '#4267b2', }}
      ...
      >
        <i class="fas fa-plus"></i>
											...
											<div class="form-group row px-4">
												...
												<div class="col-md-6">
													<div class="input-group input-group-sm mb-3">
														...
														<input
															id='yourFormId'
															type="text" class="form-control form-control-sm unique_admin_panel_name" name="admin_settings_name"
											...
											<div className='border mb-2 py-2'>
												...
												<div className='col-md-12 '>
													...
													<div className="form-group row">
														...
														<div className="col-md-3">
																	...
																	<div className="input-group-prepend">
																		<select onChange={handleHeaderFontChange} name="header_text_font" className="form-control form-control-sm">
														...
														<div className="container-fluid ">
															...
															<div className='d-flex gap-3 mt-3'>
																...
																<div style={{ marginTop: '-8px', marginLeft: '10px' }}>
																	<h4 className='header-tag' style={{ color: headerTextColor, fontFamily: headerTextFont }}>Pathshala School & College
																	</h4>
																			...
																			{selectedFile ?
																				...
																				<>
																					<img className="w-100"
																						...
																						alt="Uploaded File" />
																					<button
																						onClick={admin_template_image_remove}
																						type="button" class="btn btn-danger btn-sm position-absolute float-right ml-n4" ><FaTimes></FaTimes></button>
																				</>
																				:
																				''
