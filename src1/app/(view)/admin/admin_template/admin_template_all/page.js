...
const AdminTemplateAll = () => {
    ...
    const [getPageGroup, setGetPageGroup] = useState(() => {
    ...
    const filteredAdminPanelSettings = adminPanelSettingsBtn.filter(
        item => item.controller_name === 'admin_template'
    );
    ...
    const admin_template_delete = (id, status) => {
                            ...
                            <div class=" border-primary shadow-sm border-0">
                                <div class="card-header custom-card-header py-1  clearfix  bg-gradient-primary text-white" style={{ backgroundColor: '#4267b2' }}>
                                    ...
                                    <div class="card-title font-weight-bold mb-0 float-right">
                                        <Link href={`/Admin/admin_template/admin_template_create?page_group=${getPageGroup}`}>
                                                        ...
                                                        adminPanelSettings.map(adminPanelSetting =>
                                                            ...
                                                            <>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <Link href={`/Admin/admin_template/admin_template_edit/${adminPanelSetting.id}?page_group=${getPageGroup}`}>
                                                                        ...
                                                                        <Link href={`/Admin/admin_template/admin_template_copy/${adminPanelSetting.id}?page_group=${getPageGroup}`}>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            title='Delete'
                                                                            onClick={() => admin_template_delete(adminPanelSetting.id, adminPanelSetting.status)}
                                                                            style={{ width: "35px ", height: '30px', marginLeft: '5px', marginTop: '5px' }}
...
export default AdminTemplateAll;
