...
const NoticeCategoryList = ({ searchParams }) => {
  const {
  ...
  const brandList = moduleInfo.filter(
    (moduleI) => moduleI.controller_name === "notice_category"
  );
  ...
  const caregory_list = async () => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/notice_category/notice_category_list_paigination/${currentPage}/${dataPerPage}`;
                      ...
                      <div class="pagination float-right pagination-sm border">
                        {currentPage - 3 >= 1 && (
                          <Link
                            ...
                            href={`/Admin/notice_category/notice_category_all?page=${1}`}
                          >
                            ‹ First
                          </Link>
                        )}
                        ...
                        {currentPage + 3 <= totalPages && (
                          <Link
                            className=" text-primary px-2 border-left py-1"
                            href={`/Admin/notice_category/notice_category_all?page=${totalPages}`}
                          >
                            Last ›
                          </Link>
                        )}
                            ...
                            <tr key={noticeCategoryAll.id}>
                              ...
                              <td>
                                <div className="flex items-center ">
                                  <Link
                                    href={`/Admin/notice_category/notice_category_edit/${noticeCategoryAll.id}?page_group=${page_group}`}
                                  >
