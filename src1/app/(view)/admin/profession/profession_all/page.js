...
const ProfessionList = ({ searchParams }) => {
  const {
  ...
  const brandList = moduleInfo.filter(
    (moduleI) => moduleI.controller_name === "profession"
  );
                      ...
                      <div class="pagination float-right pagination-sm border">
                        {currentPage - 3 >= 1 && (
                          <Link
                            ...
                            href={`/Admin/profession/profession_all?page=${1}`}
                          >
                            ‹ First
                          </Link>
                        )}
                        ...
                        {currentPage + 3 <= totalPages && (
                          <Link
                            className=" text-primary px-2 border-left py-1"
                            href={`/Admin/profession/profession_all?page=${totalPages}`}
                          >
                            Last ›
                          </Link>
                        )}
                        ...
                        {isLoading ? (
                          ...
                          pageUsers.map((noticeCategoryAll, i) => (
                            <tr key={noticeCategoryAll.id}>
                              <td>{noticeCategoryAll?.profession_name}</td>
                              ...
                              <td>
                                <div className="flex items-center ">
                                  <Link
                                    href={`/Admin/profession/profession_edit/${noticeCategoryAll.id}?page_group=${page_group}`}
                                  >
