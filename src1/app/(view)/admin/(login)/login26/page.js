...
const Login26 = () => {
    ...
    return (
      ...
      color: #fff !important;}`}
            ...
            <section className="fdb-block bg-transparent border-0 p-5">
                <div className="">
                    <div className="row">
                        <div className="col-md-8 offset-md-2 justify-content-center align-items-center">
                            <div className="row no-gutters shadow justify-content-center align-items-center bg-white m-3 rounded">
                                <div className="col-12 col-md-6 text-center align-self-center" style={{ background: rgba }}>
                                    <form  >
                                ...
                                <div className="col-12 col-md-6 text-center bg-white ">
                                    <form method="post" autoComplete="off" onSubmit={handleLogin}>
                                        <div className="fdb-box">
                                            ...
                                            <div className="row mt-4">
                                                <div className="col" >
                                                    <input type="submit" name="login" className="btn btn26-hover bg-white" value="Login In" style={{ borderColor: rgbaOrg, color: rgbaOrg }} />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
