...
const Login14 = () => {
    const headerStyle = {
        background: '-webkit-linear-gradient(#fd7e14, #dc3545, #fd7e14, #242c42)',
                ...
                <div className="row d-flex justify-content-center align-items-center h-100">
                    <div className="">
                        <div className="text-center text-white font-weight-bold">
                            ...
                            <p>
                                <small className="text-dark">Dear user, log in to access the admin area!</small>
                            </p>
                        </div>
                        <div className="card rounded-3 text-black" style={{ background: "rgba(247,	80,	90, .80)" }}>
                                    ...
                                    <div className="card-body mx-md-4 p-lg-10  mx-lg-4">
                                        <form onSubmit={handleLogin}>
                                            ...
                                            <div className="text-center pt-1 mb-5 mt-2">
                                                <input
                                                    className="25 px-4 btn btn-warning mt-2" type="submit" value="Login In" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
