...
const BuyerDueReports = () => {
    ...
    const { data: supplier_due_amount_purchase_lists = [], isLoading, refetch
    } = useQuery({
    ...
    const { data: supplier_due_amount_purchase_list = [], 
    } = useQuery({
                ...
                <div className='col-12 p-4'>
                        ...
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Buyer Due Search</h5>
                                </div>
                                    ...
                                    <form >
                                        <div className="col-md-10 offset-md-1">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-form-label col-md-2"><strong>Buyer Name:</strong></label>
                                                <div className="col-md-10">
                                                    ...
                                                    >
                                                        ...
                                                        {
                                                            supplier_due_amount_purchase_lists.map(subCat =>
                                                                <>
                                                                    <option value={subCat.user_id}>{subCat.full_name}</option>
                                                                </>
                                                            )
                                                        }
                                                    </select>
                    ...
                    <div className='card'>
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Buyer Due List</h5>
                                                                ...
                                                                {isLoading ? <div className='text-center'>
                                                                    ...
                                                                    searchResults.map((supplierLastDue, i) => (
                                                                        <tr key={supplierLastDue.id}>
                                                                            <td>    {i + 1}</td>
                                                                            <td>    {supplierLastDue.full_name}</td>
                                                                            ...
                                                                            <td>    {supplierLastDue.sale_date.slice(0, 10)}</td>
                                                                            <td>    {supplierLastDue.created_date.slice(0, 10)}</td>
...
export default BuyerDueReports;