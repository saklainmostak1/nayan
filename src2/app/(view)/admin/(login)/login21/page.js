...
const Login21 = () => {
    ...
    return (
        <section style={{
            backgroundImage: "url('https://api.urbanitsolution.com/web_content/login/21/imgs/hero/alan-stone-family-personal.svg')",
                                    ...
                                    <div className="card-body mx-md-4 p-lg-10  mx-lg-4">
                                        <form onSubmit={handleLogin}>
                                            ...
                                            <div className="text-center pt-1 mb-5 mt-2">
                                                <input
                                                    className="btn 25 px-4 btn btn-outline-info mt-2" type="submit" value="Login In" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
