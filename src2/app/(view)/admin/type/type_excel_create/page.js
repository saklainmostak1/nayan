...
const CreateTypeExcel = () => {
    ...
    //         anchor.href = url;
    //         anchor.download = "Type Excel Form.xlsx";
    //         anchor.click();
    ...
    //     const headers = [
    //         { header: "Type Name*", key: "type_name", width: 25 },
                        ...
                        <div className="card-default">
                            ...
                            {/* <div class="form-group row ml-2">
                                <div class="col-md-6 ">
                                    <span className=" mb-2 mt-2">
                                        ...
                                        <input className='mb-0' type="file" multiple accept=".xlsx, .xls" onChange={type_file_upload} id={`fileInput`} style={{ display: "none" }} />
                                    </span>
                                    <span className=" mb-2 mt-2 ml-3">
                                        ...
                                        <input onClick={type_excel_file_export} type="button" name="search" class="btn btn-sm btn-secondary excel_btn ml-2" id={`fileInpu`} style={{ display: "none" }} />
                                    </span>
                                </div>
                            </div> */}
                            ...
                            {/* <div class="form-group row ml-2">
                                <div class="col-md-6 ">
                                    ...
                                    <span className="btn btn-secondary btn-sm mb-2 mt-2 ml-3">
                                        <label htmlFor={`fileInpu`} className='mb-0'><FaDownload></FaDownload> Smaple Excel File </label>
                                        <input onClick={type_excel_file_export} type="button" name="search" class="btn btn-sm btn-secondary excel_btn ml-2" id={`fileInpu`} style={{ display: "none" }} />
                                    </span>

                                </div>
                            </div> */}
                            {/* <input onClick={type_excel_file_export} type="button" name="search" class="btn btn-sm btn-secondary excel_btn ml-2" value="Download Excel " /> */}
                            ...
                            <div class="col-md-9 offset-md-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small><span className='text-danger font-weight-bold'>***</span>Download type Excell Format. Fill up with type information and upload this file to quick data entry. </small>
                                    </div>
                                </div>
...
export default CreateTypeExcel;