...
const SettingsMaterial = () => {
    ...
    const material = module_settings.filter(moduleI => moduleI.table_name === 'material')
                        ...
                        <div class="body-content bg-light">
                            ...
                            <div class=" border-primary shadow-sm border-0">
                                <div class=" card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Material Settings</h5>
                                ...
                                <div class="card-body">
                                    <form onSubmit={material_settings_create}>
                                        <div class="col-md-9 offset-md-1">
                                            <div class="form-group row student d-none">
                                                ...
                                                <div class="col-md-4">
                                                    <input
                                                        defaultValue={material[0]?.table_name}
