...
const LoanPaymentLists = ({ searchParams }) => {
    ...
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'loan')
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_list_paigination/${currentPage}/${dataPerPage}`;
    ...
    const loan_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
    ...
    const loan_search = () => {
        ...
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_search`, {
    ...
    const loan_payment_pdf = async () => {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_search`, {
            toDate, fromDate, account_heads, loan_type, status
        });
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_pdf`, {
                method: 'POST',
                headers: {
    ...
    const loan_payment_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/loan_payment/loan_payment_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                            ...
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    ...
                                    <div className="card-title font-weight-bold mb-0 card-header-color float-right">
                                        <Link href={`/Admin/loan_payment/loan_payment_create?page_group`} className="btn btn-sm btn-info">Loan Payment Create</Link>
                                    </div>
                                </div>
                                                                        ...
                                                                        <tr key={loan.id}>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div className="flex items-center ">
                                                                                    <Link href={`/Admin/loan_payment/loan_payment_edit/${loan.id}?page_group=${page_group}`}>
                                            ...
                                            <div className='table-responsive'>
                                                <div className=" d-flex justify-content-between">
                                                    ...
                                                    <div class="pagination float-right pagination-sm border">
                                                        {
                                                            currentPage - 3 >= 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/loan_payment/loan_payment_all?page=${1}`}>‹ First</Link>
                                                            )
                                                        }
                                                        {
                                                            currentPage > 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/loan_payment/loan_payment_all?page=${activePage - 1}`}>&lt;</Link>
                                                            )
                                                        }
                                                        {
                                                            pageNumber.map((page) =>
                                                                <Link
                                                                    key={page}
                                                                    href={`/Admin/loan_payment/loan_payment_all?page=${page}`}
                                                        ...
                                                        }
                                                        {
                                                            currentPage + 3 <= totalPages && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/loan_payment/loan_payment_all?page=${totalPages}`}>Last ›</Link>
                                                            )
                                                        }
                                                    </div>
...
export default LoanPaymentLists;