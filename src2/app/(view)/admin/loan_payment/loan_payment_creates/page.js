...
const LoanPaymentCreates = () => {
    ...
    const [assetInfo, setAssetInfo] = useState({
        loan: '', account: '', reference: '', amount: '', interest: '', aviable_balance: '', due: '', payable_amount: '', payment_date: '', note: '', status: '', created_by: created, img: '', remaining_balance: ''
    });
                    ...
                    <div className='card'>
                        <div class=" border-primary shadow-sm border-0">
                            <div class="card-header py-1  custom-card-header clearfix bg-gradient-primary text-white">
                                <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Create Loan Payment</h5>
                                <div class="card-title font-weight-bold mb-0 card-header-color float-right">
                                    <Link href={`/Admin/loan_payment/loan_payment_all?page_group=${page_group}`} class="btn btn-sm btn-info"> Loan Payment List</Link></div>
                            </div>
                                    ...
                                    <div class=" row no-gutters">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" readOnly name="amount" value={assetInfo.amount} onChange={brand_input_change}
                                                        class="form-control form-control-sm  required "
...
export default LoanPaymentCreates;
