...
const SupplierCreates = () => {
    ...
    const asset_type_create = (e) => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/supplier/supplier_address_create`, {
            method: 'POST',
            headers: {
    ...
    const brand_image_remove = (index) => {
        ...
        if (confirmDelete) {
            ...
            setSelectedFile(newSelectedFiles);
            const filePathToDelete = setAssetType.img;
            if (filePathToDelete) {
...
export default SupplierCreates;
