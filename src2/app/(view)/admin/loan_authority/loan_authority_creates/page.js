...
const LoanOthorityCreates = () => {
    ...
    const asset_type_create = (e) => {
        ...
        if (existingBrand) {
            // Show error message
            setSameBrandName("This ame already exists. Please choose a different  name.");
                    ...
                    <div className='card'>
                        <div class=" border-primary shadow-sm border-0">
                            <div class="card-header py-1  custom-card-header clearfix bg-gradient-primary text-white">
                                <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Create Loan Othority</h5>
                                <div class="card-title font-weight-bold mb-0 card-header-color float-right">
                                    <Link href={`/Admin/loan_authority/loan_authority_all?page_group=${page_group}`} class="btn btn-sm btn-info">Loan Othority List</Link></div>
                            </div>
...
export default LoanOthorityCreates;
