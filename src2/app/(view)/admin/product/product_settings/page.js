...
const SettingsProducts = () => {
    ...
    const model = module_settings.filter(moduleI => moduleI.table_name === 'product')
    ...
    const product_settings_create = (event) => {
                        ...
                        <div class="body-content bg-light">
                            <div class=" border-primary shadow-sm border-0">
                                <div class=" card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Product Settings</h5>
                                ...
                                <div class="card-body">
                                    <form onSubmit={product_settings_create}>
