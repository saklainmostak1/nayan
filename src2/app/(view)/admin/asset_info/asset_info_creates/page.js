...
const AssetInfoCreates = () => {
    ...
    const [assetInfo, setAssetInfo] = useState({
        asset_name: '', asset_type_id: '', asset_cost: '', note: '', depreciation: '', date: '', status: '', created_by: created, img: ''
    });
                    ...
                    <div className='card'>
                        <div class=" border-primary shadow-sm border-0">
                            <div class="card-header py-1  custom-card-header clearfix bg-gradient-primary text-white">
                                <h5 class="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Create Asset Info</h5>
                                <div class="card-title font-weight-bold mb-0 card-header-color float-right">
                                    <Link href={`/Admin/asset_info/asset_info_all?page_group=${page_group}`} class="btn btn-sm btn-info"> Asset Info List</Link></div>
                            </div>
