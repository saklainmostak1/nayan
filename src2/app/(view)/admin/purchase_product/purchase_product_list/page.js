...
const ProductPurchaseList = ({ searchParams }) => {
    ...
    const brandList = moduleInfo.filter(moduleI => moduleI.controller_name === 'purchase_product')
    ...
    const asset_info_word_download = async () => {
        try {
            ...
            const dataRows = await Promise.all(searchResults.map(async (category, index) => {
                // Fetch image data
                const purchase_price = category.purchase_price != null ? `${category.purchase_price}` : ''; // Ensures 
                const sale_price = category.sale_price != null ? `${category.sale_price}` : ''; // Ensures 
                ...
                return new TableRow({
                    children: [
                        ...
                        new TableCell({
                            children: [new Paragraph({ text: category.product_name ? `${category.product_name}` : '' })], // Ensure Employee ID is treated as text
                            borders: {},
                        }),
                        new TableCell({
                            children: [new Paragraph({ text: category.unit_name })],
                            borders: {},
                        }),
                        new TableCell({
                            children: [new Paragraph({ text: purchase_price })],
                            borders: {},
                        }),
                        ...
                        new TableCell({
                            children: [new Paragraph({ text: category.created_by })],
                            borders: {},
                        }),
                ...
                <div className='col-12 p-4'>
                        ...
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Purchase Product Search</h5>
                                </div>
                                    ...
                                    <form >
                                        <div className="col-md-10 offset-md-1">
                                            ...
                                            <div className="form-group row">
                                                ...
                                                <label className="col-form-label col-md-2"><strong>Unit:</strong></label>
                                                <div className="col-md-4">
                                                    <select
                    ...
                    <div className='card'>
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">List Purchase Product</h5>
                                    <div className="card-title font-weight-bold mb-0 card-header-color float-right">
                                        <Link href={`/Admin/purchase_product/purchase_product_create?page_group`} className="btn btn-sm btn-info">Purchase Product Create</Link>
                                    </div>
                                </div>
                                {loading ? (
                                                            ...
                                                            {isLoading ? <div className='text-center'>
                                                                ...
                                                                searchResults.map((asset_info, i) => (
                                                                    <tr key={asset_info.id}>
                                                                        ...
                                                                        <td>
                                                                            {asset_info.sale_price}
                                                                        </td>
                                                                        <td>
                                                                            {`${asset_info.created_by}  ${asset_info.created_date.slice(0, 10)}`}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div className="flex items-center ">
                                                                                <Link href={`/Admin/purchase_product/purchase_product_edit/${asset_info.id}?page_group=${page_group}`}>
                                            ...
                                            <div className='table-responsive'>
                                                <div className=" d-flex justify-content-between">
                                                    ...
                                                    <div class="pagination float-right pagination-sm border">
                                                        {
                                                            currentPage - 3 >= 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/purchase_product/purchase_product_all?page=${1}`}>‹ First</Link>
                                                            )
                                                        }
                                                        {
                                                            currentPage > 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/purchase_product/purchase_product_all?page=${activePage - 1}`}>&lt;</Link>
                                                            )
                                                        }
                                                        {
                                                            pageNumber.map((page) =>
                                                                <Link
                                                                    key={page}
                                                                    href={`/Admin/purchase_product/purchase_product_all?page=${page}`}
                                                        ...
                                                        }
                                                        {
                                                            currentPage + 3 <= totalPages && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/purchase_product/purchase_product_all?page=${totalPages}`}>Last ›</Link>
                                                            )
                                                        }
                                                    </div>
