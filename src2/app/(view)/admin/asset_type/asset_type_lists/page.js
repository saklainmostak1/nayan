...
const AssetTypeLists = ({ searchParams }) => {
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/asset_type/asset_type_list_paigination/${currentPage}/${dataPerPage}`;
    ...
    const asset_type_delete = id => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/asset_type/asset_type_delete/${id}`, {
            method: "POST",
        })
            .then(response => {
    ...
    const asset_search = () => {
        setLoading(true);
        axios.post(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/asset_type/asset_type_search`, {
    ...
    const asset_type_pdf_download = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/asset_type/asset_type_pdf`, {
                method: 'POST',
                headers: {
    ...
    const asset_type_print = async () => {
        try {
            ...
            const html = await fetch(`${process.env.NEXT_PUBLIC_API_URL}:5002/Admin/asset_type/asset_type_print`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            const dataRows = await Promise.all(searchResults.map(async (category, index) => {
                ...
                return new TableRow({
                    children: [
                        ...
                        new TableCell({
                            children: [new Paragraph({ text: category.asset_type_name ? `${category.asset_type_name}` : '' })], // Ensure Employee ID is treated as text
                            borders: {},
                        }),
                        new TableCell({
                ...
                <div className='col-12 p-4'>
                        ...
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">Asset Type Search</h5>
                                </div>
                                <div className="card-body">
                                    <form >
                                        <div className="col-md-10 offset-md-1">
                                            <div className="form-group row">
                                                <label className="col-form-label col-md-2"><strong>Asset Type Name:</strong></label>
                    ...
                    <div className='card'>
                        <div className="body-content bg-light">
                            <div className="border-primary shadow-sm border-0">
                                <div className="card-header py-1 custom-card-header clearfix bg-gradient-primary text-white">
                                    <h5 className="card-title font-weight-bold mb-0 card-header-color float-left mt-1">List Asset Type</h5>
                                    <div className="card-title font-weight-bold mb-0 card-header-color float-right">
                                        <Link href={`/Admin/asset_type/asset_type_create?page_group`} className="btn btn-sm btn-info">Asset Type Create</Link>
                                    </div>
                                </div>
                                {loading ? (
                                                        ...
                                                        <tbody>
                                                            {searchResults.map((asset_type, i) => (
                                                                <tr key={asset_type.id}>
                                                                    ...
                                                                    <td>
                                                                        {asset_type.status === 1 ? "Active"
                                                                            : asset_type.status === 2 ? "Inactive"
                                                                                : asset_type.status === 3 ? "Pending"
                                                                                    : "Unknown"}
                                                                    </td>
                                                                    <td>
                                                                        {asset_type.note}
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div className="flex items-center ">
                                                                            <Link href={`/Admin/asset_type/asset_type_edit/${asset_type.id}?page_group=${page_group}`}>
                                            ...
                                            <div className='table-responsive'>
                                                <div className=" d-flex justify-content-between">
                                                    ...
                                                    <div class="pagination float-right pagination-sm border">
                                                        {
                                                            currentPage - 3 >= 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_type/asset_type_all?page=${1}`}>‹ First</Link>
                                                            )
                                                        }
                                                        {
                                                            currentPage > 1 && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_type/asset_type_all?page=${activePage - 1}`}>&lt;</Link>
                                                            )
                                                        }
                                                        {
                                                            pageNumber.map((page) =>
                                                                <Link
                                                                    key={page}
                                                                    href={`/Admin/asset_type/asset_type_all?page=${page}`}
                                                        ...
                                                        }
                                                        {
                                                            currentPage + 3 <= totalPages && (
                                                                <Link className=" text-primary px-2 border-left py-1" href={`/Admin/asset_type/asset_type_all?page=${totalPages}`}>Last ›</Link>
                                                            )
                                                        }
                                                    </div>
